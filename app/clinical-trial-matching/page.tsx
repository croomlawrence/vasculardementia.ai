    ...
    <main className="max-w-6xl mx-auto px-6 py-16">
      <section className="text-center mb-16">
        ...
        <p className="text-2xl text-black max-w-4xl mx-auto">
          Your Acurist.AI benchmark may help organize whether you should ask about clinical research investigating next-generation vascular dementia and vascular cognitive impairment approaches.
        </p>
      </section>
