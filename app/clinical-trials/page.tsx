...
export const metadata: Metadata = {
  ...
  description: "Learn about clinical research for cognitive health and how to discuss potential study options with qualified clinicians or study teams.",
};
...
export default function ClinicalTrialsPage() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-20">
      ...
      <div className="green-wash border-2 border-black rounded-3xl p-8 lg:p-12 mb-12">
        ...
        <div className="prose prose-lg">
            ...
            <ol>
                <li><strong>Screening:</strong> First, a research team determines whether you meet the specific criteria for a study.</li>
      ...
      <div className="text-center border-t pt-12 mt-12">
        ...
        <p className="text-xl text-black mb-10 max-w-3xl mx-auto">
          Not all clinical trials are the same. Explore major categories of research being done to better understand vascular cognitive conditions and potential investigational approaches.
        </p>
        <Link 
      ...
      <div className="text-center border-t pt-12 mt-12">
        ...
        <p className="text-xl text-black mb-10 max-w-3xl mx-auto">
          If you're ready, the first step is a short, informational pre-screener that can help organize what to discuss with clinicians or study teams. VascuMind does not determine trial eligibility.
        </p>
