...
const pains = [
  ...
  ["Weak vascular differentiation", "Many recruitment funnels do not separate ischemic-pattern, mixed, and non-vascular cognitive concerns early enough."],
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-16">
      ...
      <section className="border-4 border-black rounded-3xl p-8 md:p-12 mb-16 brand-section-ivory">
        ...
        <h2 className="text-4xl font-semibold mb-6">Consumer-grade front door. Vascular differentiation. Structured memory baseline. Consent-aware routing.</h2>
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="border border-black rounded-2xl p-6"><strong>Better fit:</strong><br />Route ischemic-pattern and mixed impairment into better-aligned trial pathways.</div>
