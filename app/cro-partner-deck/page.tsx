...
const slides = [
  ["Problem", "CROs and sponsors need vascular-specific cognitive candidates, but recruitment often mixes MCI, ischemic-pattern impairment, non-vascular causes, and nonspecific memory complaints."],
