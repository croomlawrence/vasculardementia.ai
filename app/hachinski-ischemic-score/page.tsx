...
export const metadata: Metadata = {
  ...
  description: "Learn what the Hachinski Ischemic Score is, what vascular-pattern features it organizes, and how to use VascuMind’s free educational check before a clinician conversation.",
...
export default function HachinskiExplainerPage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16">
      ...
      <h1 className="text-5xl md:text-6xl font-semibold tracking-tight mb-6">A plain-language way to organize vascular-pattern cognitive clues.</h1>
