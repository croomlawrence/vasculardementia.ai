  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="border border-black rounded-2xl p-6 mb-12">
        ...
        <p className="text-black">
          Evidence context: <a href="https://pubmed.ncbi.nlm.nih.gov/33357194/" className="underline">review a supporting clinical-science source for Vitamin D3 + K2</a>. Evidence varies by population, dose, and outcome and does not make this product a disease treatment.
        </p>
      </div>
