  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16">
      <section className="border-4 border-black rounded-3xl p-8 md:p-12 text-center mb-12">
        ...
        <h1 className="text-5xl font-semibold tracking-tight mb-6">Your MCI Screen benchmark creates two VascuMind Protocol paths</h1>
      ...
      <section className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="border-4 border-black rounded-3xl p-8">
          ...
          <p className="text-xl text-black mb-6">
            Your MCI Screen benchmark shows changes worth discussing. Support vascular and cognitive wellness foundations with the VascuMind Protocol Stack — citicoline, high-EPA omega-3, and MCT oil — after clinician review and supplier/COA checks.
          </p>
        ...
        <div className="border-4 border-black rounded-3xl p-8">
          ...
          <p className="text-xl text-black mb-6">
            Your MCI Screen benchmark may be useful when asking about clinical studies investigating vascular cognitive impairment and related approaches. Opt in before VascuMind evaluates current-study fit.
          </p>
